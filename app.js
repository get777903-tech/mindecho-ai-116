...
function buildScriptText(childName, mins) {
  ...
  const introGreeting = cleanName
    ? `Дорогой мой. <break time="2.0s"/> Родной человечек, ${cleanName}. <break time="3.0s"/>`
    : `Дорогой мой. <break time="2.0s"/> Родной человечек. <break time="3.0s"/>`;

  // ВСТУПЛЕНИЕ (всегда, 2 блока) — короткие гипнотические фразы, не более 5 слов до паузы
  const baseIntro = [
    introGreeting,
    `Я хочу взять тебя. <break time="1.5s"/> В небольшое путешествие. <break time="2.0s"/> В волшебное место. <break time="1.5s"/> Где мысли становятся реальностью. <break time="2.0s"/> Расслабься. <break time="1.5s"/> Отправимся в путь. <break time="3.0s"/>`,
    `Закрой глаза. <break time="2.0s"/> Дыши спокойно. <break time="1.5s"/> Ровно и глубоко. <break time="2.0s"/> Почувствуй тепло. <break time="1.5s"/> По всему телу. <break time="2.0s"/> Вокруг тебя — <break time="1.0s"/> мягко и безопасно. <break time="3.0s"/>`
  ];

  // ОСНОВНЫЕ БЛОКИ — 6 блоков, каждый не более 20–25 слов суммарно
  const bodyBlocks = [
    // Блок 3: место, любовь родителей
    `Представь красивое место. <break time="2.0s"/> Самое красивое на свете. <break time="1.5s"/> Побудь там. <break time="2.0s"/> Мама и папа рядом. <break time="1.5s"/> Всегда рядом с тобой. <break time="2.0s"/> Мы тебя любим. <break time="1.5s"/> Очень сильно. <break time="3.0s"/>`,

    // Блок 4: волшебница
    `В этом мире. <break time="1.5s"/> Ты — волшебница. <break time="2.0s"/> Всё, во что веришь. <break time="1.5s"/> Сбывается. <break time="2.0s"/> Ты умная. <break time="1.5s"/> Учишься легко. <break time="1.5s"/> Твоё тело здорово. <break time="3.0s"/>`,

    // Блок 5: страхи тают
    `Все тревоги тают. <break time="2.0s"/> Как снег на солнце. <break time="1.5s"/> С каждым выдохом. <break time="2.0s"/> Страхи испаряются. <break time="3.0s"/>`,

    // Блок 6: сокровище
    `Верь в себя. <break time="2.0s"/> Ты можешь всё. <break time="1.5s"/> Ты — сокровище. <break time="2.0s"/> Наша любовь с тобой. <break time="1.5s"/> Всегда. <break time="3.0s"/>`,

    // Блок 7: храбрость, свобода
    `Почувствуй прямо сейчас. <break time="1.5s"/> Ты храбрая. <break time="2.0s"/> Ты свободная. <break time="1.5s"/> Ты счастливая. <break time="2.0s"/> Внутри тебя. <break time="1.5s"/> Безграничная энергия. <break time="3.0s"/>`,

    // Блок 8: благодарность, нежность
    `Твоя жизнь прекрасна. <break time="2.0s"/> Полна приключений. <break time="1.5s"/> Улыбнись мысленно. <break time="2.0s"/> Почувствуй нежность. <break time="1.5s"/> К самой себе. <break time="3.0s"/>`
  ];

  // ЗАВЕРШЕНИЕ
  const outro = [
    `Ты свободна. <break time="1.5s"/> Ты счастлива. <break time="2.0s"/> У тебя есть всё. <break time="1.5s"/> Всё для счастья. <break time="2.0s"/> Появилась отличная идея. <break time="1.5s"/> Ты знаешь, как её воплотить. <break time="2.0s"/> Улыбнись мысленно. <break time="1.5s"/> Почувствуй нежность к себе. <break time="2.0s"/> Сохрани этот покой. <break time="1.5s"/> Тебя ждёт чудесный день. <break time="3.0s"/>`
  ];

  // Масштабирование: 5 мин = 1 повтор, 10 мин = 2, 30 мин = 6
